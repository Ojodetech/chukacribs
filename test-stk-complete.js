...
const testSTKPushComplete = async () => {
    let connection;
    try {
        console.log('🚀 COMPLETE STK PUSH TEST FOR 0715255115\n');
        ...
        // Create/Get Room
        console.log('\n🏠 Creating/Getting test room...');
        let room = await Room.findOne({ name: 'STK Test Room' });
